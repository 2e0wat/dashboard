                  ...
                  <th colspan="7">
                     <table width="100%" border="0">
                        <tr>
                           ...
                           echo '
                           <td>
                              <a href="./index.php?do=resetfilter"><button class="FilterSubmit">Reset</button></a>
                           </td>';
                           }
         ...
         <?php
            ...
            for ($i=0;$i<$Reflector->StationCount();$i++) {
               ...
               if ($ShowThisStation) {
                  ...
                  echo '
                     <tr bgcolor="'.$odd.'" onMouseOver="this.bgColor=\''.$seclt.'\';" onMouseOut="this.bgColor=\''.$odd.'\';">                  
                        ...
                        <td align="center" valign="middle" width="40">';
                           ...
                           if (file_exists("./img/flags/".$Flag.".png")) {
                              echo '<a href="http://www.aprs.fi/'.$Reflector->Stations[$i]->GetCallsignOnly().'" class="tip" target="_blank"><img src="./img/flags/'.$Flag.'.png" height="15" alt="'.$Name.'" /><span>'.$Name.'</span></a>';
                           }
                        echo '</td>

                        <td align="center" valign="middle" width="80">
                           <a href="https://www.qrz.com/db/'.$Reflector->Stations[$i]->GetCallsignOnly().'" target="_blank">'.$Reflector->Stations[$i]->GetCallsignOnly().'</a>
                        </td>
                        
                        <td align="center" valign="middle" width="75">'.$Reflector->Stations[$i]->GetSuffix().'</td>
                        
                        <td align="center" valign="middle" width="100">'.$Reflector->Stations[$i]->GetVia();
                           if ($Reflector->Stations[$i]->GetPeer() != $Reflector->GetReflectorName()) {
                              echo ' / '.$Reflector->Stations[$i]->GetPeer();
                           }
                        echo '</td>

                        <td align="center" valign="middle" width="150">'.@date("d/m/Y H:i", $Reflector->Stations[$i]->GetLastHeardTime()).'</td>

                        <td align="center" valign="middle" width="30">'.$Reflector->Stations[$i]->GetModule().'</td>
                     ...
                     <td valign="top" style="border:0px;padding:0px;">
                        <table width="125px" border="0" style="padding:0px;margin:0px;">';
                           ...
                           for ($j=0;$j<count($Users);$j++) {
                              ...
                              echo '
                              <tr bgcolor="'.$odd.'" onMouseOver="this.bgColor=\''.$seclt.'\';" onMouseOut="this.bgColor=\''.$odd.'\';">
                                 <td align="center" style="$prilt solid;"><a href="http://www.aprs.fi/'.$Displayname.'" class="pl" target="_blank">'.$Displayname.'</a></td>
                              </tr>';
